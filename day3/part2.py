...
def compare_star_symbol_numbers(symbols, numbers):
    number_pairs = []
            ...
            for number in numbers:
                ...
                for corner in transf:
                    ...
                    if tx in range(xs, xe + 1) and ty == ny:
                        ...
                        break
            number_pairs.append(numbers_w_symbols)

    return numbers_w_symbols, number_pairs


def gear_symbol(number_pairs):
    gears = []
...
if __name__ == '__main__':
    ...
    connecting_numbers, number_pairs = (compare_star_symbol_numbers(symbols, numbers))
    gears = gear_symbol(number_pairs)
